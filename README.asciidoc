...
Many Operating Systems offer a prebuild HAProxy package, but often they are very outdated. It is recommended to compile your own HAProxy for production use.
